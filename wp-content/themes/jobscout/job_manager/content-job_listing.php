...
<article <?php job_listing_class(); ?> data-longitude="<?php echo esc_attr( $post->geolocation_lat ); ?>"
    ...
    <div class="flex flex-col">
        ...
        <div class="p-1 ml-[10px]">
            <h1
                class=" py-[3px] before:content-[''] before:w-1 before:h-1  before:bg-black before:absolute before:rounded-full before:mt-[7px]  before:-ml-[9px]   text-xs text-black-300 ">
                Thong tin nguoi dung ung tuyen vi tri job nay</h1>
            <h1
                class="py-[3px] before:content-[''] before:w-1 before:h-1  before:bg-black before:absolute before:rounded-full before:mt-[7px]  before:-ml-[9px]   text-xs text-black-300 ">
                Thong tin nguoi dung ung tuyen vi tri job nay</h1>
            <h1
